...
class Flight {
	...
	public Flight(String flightNo, String source, String destination, String departureTime,
	              int totalSeatsEconomy, int totalSeatsBusiness, double priceEconomy, double priceBusiness) {
	...
	public String toString() {
		return String.format("[Flight %s] %s -> %s at %s |\nEconomy: %d/%d | Business: %d/%d |\nEconomy Seat: ₹%.0f | Business Seat: ₹%.0f\n",
				flightNo, source, destination, departureTime,
				availableSeatsEconomy, totalSeatsEconomy,
				availableSeatsBusiness, totalSeatsBusiness, priceEconomy, priceBusiness);
	}
}