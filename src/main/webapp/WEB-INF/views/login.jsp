...
<%--			</div>--%>
<%--			<a href="${pageContext.request.contextPath}/login" type="submit" >--%>
<%--				<span></span>--%>
<%--				<span></span>--%>
<%--				<span></span>--%>
<%--				<span></span>--%>
...
<%--			</a>--%>
<%--		</form>--%>
<%--		<p>Don't have an account? <a href="${pageContext.request.contextPath}/register" class="a2">Sign up!</a></p>--%>
<%--	</div>--%>
<%--	<c:if test="${not empty error}"><p style="color:red">${error}</p></c:if>--%>
	<div class="login-box">
		...
		<p>Don't have an account?
			<a href="${pageContext.request.contextPath}/register" class="a2">Sign up!</a>
		</p>
	</div>
