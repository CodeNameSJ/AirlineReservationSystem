...
public class AdminBookingController {
	...
	public String saveBooking(HttpServletRequest req, @RequestParam(required = false) Long id,
			...
			@RequestParam SeatClass seatClass, @RequestParam(required = false) BookingStatus status, Model model,
		...
		try {
			...
			Booking booking = isNewBooking ? bookingService.createBooking(userId, flightId, seatClass, seats)
			...
			ra.addFlashAttribute("successMessage", (isNewBooking ? "Booking created" : "Booking updated") + ": #"
					+ booking.getId() + " for flight " + flightNumber + ".");
