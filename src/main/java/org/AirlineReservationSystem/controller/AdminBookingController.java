...
public class AdminBookingController {
  ...
  public AdminBookingController(
      BookingService bookingService, UserService userService, FlightService flightService) {
  ...
  public String saveBooking(
    ...
    try {
      ...
      String flightNumber =
          booking.getFlight() != null ? booking.getFlight().getFlightNumber() : "N/A";
      ra.addFlashAttribute(
          "successMessage",
          (isNewBooking ? "Booking created" : "Booking updated")
              + ": #"
              + booking.getId()
              + " for flight "
              + flightNumber
