...
public final class DateUtils {
  ...
  /**
   * Build and add departure/arrival formatted maps into the model. Attribute names used:
   * "departureMap" and "arrivalMap". Usage: DateUtils.addFormattedMaps(model, showFlights);
   */
